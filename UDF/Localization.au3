...
Func _Localization_Custom()
	...
	$g_aLangCustom[15] = _Localization_Load("Custom", "Tip_Status_Show", "Show Status")
	$g_aLangCustom[16] = _Localization_Load("Custom", "Tip_Status_Hide", "Hide Status")
	$g_aLangCustom[17] = _Localization_Load("Custom", "Button_Go", "Go!")
	$g_aLangCustom[18] = _Localization_Load("Custom", "Button_Go_Stop", "Stop")
	$g_aLangCustom[19] = _Localization_Load("Custom", "Info_01", "Before you start; it is recommended that you create a System Restore Point to roll back any changes made by Complete Internet Repair. Furthermore, run the build-in Windows Internet Troubleshooters before any repair options.\rn\rnSelect your repair options and press '%s' to start. Do not select something unless your computer has the described problem. Skip any option you do not understand.")
	$g_aLangCustom[20] = _Localization_Load("Custom", "Info_02", "This option rewrites important registry keys that are used by the Internet Protocol (TCP/IP) stack. This has the same result as removing and reinstalling the protocol.")
	$g_aLangCustom[21] = _Localization_Load("Custom", "Info_03", "This can be used to recover from Winsock corruption result in lost of network connectivity. This option should be used with care becuase any pre-installed LSP's will need to be reinstalled.")
	$g_aLangCustom[22] = _Localization_Load("Custom", "Info_04", "Release and renew all Interent (TCP/IP) connections.")
	$g_aLangCustom[23] = _Localization_Load("Custom", "Info_05", "Flush DNS Resolver Cache, refresh all DHCP leases and re-register DNS names.")
	$g_aLangCustom[24] = _Localization_Load("Custom", "Info_06", "ARP (Address Resolution Protocol) Cache is a technique used to store 'mappings' of OSI Model Network Layer addresses (IP addresses) to corresponding OSI Model Data Link addresses (MAC addresses). Due to a variety of possible circumstances, ARP cache can become damaged.\rn\rnSymptoms include: numerous websites fail to load, and interruptions in network or internet connectivity. The Ping command will also fail to work for communicating with two or more remote hosts.")
	$g_aLangCustom[25] = _Localization_Load("Custom", "Info_07", "Re-registers all the concerned dll and ocx files required for a smooth operation of Microsoft Internet Explorer %s.")
	$g_aLangCustom[26] = _Localization_Load("Custom", "Info_08", "This option will clear the Windows Update History. It will do this by emptying the [%s] and [%s] directories.")
	$g_aLangCustom[27] = _Localization_Load("Custom", "Info_09", "This option will try and fix Windows Update / Automatic Updates. Try this when you are unable to download or install updates.")
	$g_aLangCustom[28] = _Localization_Load("Custom", "Info_10", "If you are having trouble connecting to SSL / Secured websites (Ex. Banking) then this option could help.")
	$g_aLangCustom[29] = _Localization_Load("Custom", "Info_11", "Many malware infections create proxy servers and then set Windows to route all web traffic through the virus proxy. For example, an attempt to access Rizonesoft.com, will redirect to a malware site.\rn\rnThis option will attempt to reset all proxy configurations, including persistent WinHTTP proxy configuration.")
	$g_aLangCustom[30] = _Localization_Load("Custom", "Info_12", "Reset the Windows Firewall configuration to its default state.")
	$g_aLangCustom[31] = _Localization_Load("Custom", "Info_13", "Reset the Windows hosts file to its default state.")
	$g_aLangCustom[32] = _Localization_Load("Custom", "Info_14", "It is sometimes necessary that clients or servers on your network need to reregister their NetBIOS names with a Windows Internet Name Service (WINS) server.\rn\rnHere are some situations where renewing WINS client registrations would be necessary: The registration has been lost or deleted in WINS and needs to be refreshed by the client. The registration exists in some WINS servers but not in others. A reregistration is useful here to increment the WINS version Ids, which will help in causing a WINS server replication to occur.")
	$g_aLangCustom[33] = _Localization_Load("Custom", "Label_Sub_Heading_Notice", "Complete Internet Repair functionality now bundled with Complete Windows Repair. Click here to download it now and evolve!!")
	$g_aLangCustom[34] = _Localization_Load("Custom", "Label_All_Complete", "All selected tasks Complete.")
...
Func _Localization_Menus()
	...
	$g_aLangMenus[39] = _Localization_Load("Menus", "Help_Contact", "&Contact %{Company.Name}")
...
Func _Localization_Messages2()
	...
	$g_aLangMessages2[94]  = _Localization_Load("Messages2", "Open_Events_01", "Opening Windows Event Viewer.")
	$g_aLangMessages2[95]  = _Localization_Load("Messages2", "Open_Events_02", "Event Viewer should be open now.")
	$g_aLangMessages2[96]  = _Localization_Load("Messages2", "Export_IP_01", "Exporting Windows IP Configuration.")
	$g_aLangMessages2[97]  = _Localization_Load("Messages2", "Export_IP_02", "Windows IP Configuration Saved to '%s'")
	$g_aLangMessages2[98]  = _Localization_Load("Messages2", "Export_IP_03", "Could not save IP Configuration.")
	$g_aLangMessages2[99]  = _Localization_Load("Messages2", "Export_LSPs_01", "Exporting Installed Winsock LSPs.")
	$g_aLangMessages2[100] = _Localization_Load("Messages2", "Export_LSPs_02", "Winsock LSPs list Saved to '%s'")
	$g_aLangMessages2[101] = _Localization_Load("Messages2", "Export_LSPs_03", "Could not save LSP list.")
	$g_aLangMessages2[102] = _Localization_Load("Messages2", "Export_ARP_01", "Exporting ARP entries.")
	$g_aLangMessages2[103] = _Localization_Load("Messages2", "Export_ARP_02", "ARP entries Saved to '%s'")
	$g_aLangMessages2[104] = _Localization_Load("Messages2", "Export_ARP_03", "Could not save ARP entries.")
	$g_aLangMessages2[105] = _Localization_Load("Messages2", "Export_NBIOS_01", "Exporting NetBIOS Statistics.")
	$g_aLangMessages2[106] = _Localization_Load("Messages2", "Export_NBIOS_02", "NetBIOS Statistics Saved to '%s'")
	$g_aLangMessages2[107] = _Localization_Load("Messages2", "Export_NBIOS_03", "Could not save NetBIOS Statistics.")
	$g_aLangMessages2[108] = _Localization_Load("Messages2", "Tools_Open_RDP_01", "Opening Remote Desktop Connection.")
	$g_aLangMessages2[109] = _Localization_Load("Messages2", "Tools_Open_RDP_02", "Could not open Remote Desktop Connection.")
	$g_aLangMessages2[110] = _Localization_Load("Messages2", "Tools_Open_RDP_03", "Remote Desktop Connection should be Open.")
	$g_aLangMessages2[111] = _Localization_Load("Messages2", "Tools_Open_IE_Properties_01", "Opening Internet Explorer Properties.")
	$g_aLangMessages2[112] = _Localization_Load("Messages2", "Tools_Open_IE_Properties_02", "Could not open Internet Explorer Properties.")
	$g_aLangMessages2[113] = _Localization_Load("Messages2", "Tools_Open_IE_Properties_03", "You should see Internet Explorer Properties.")
	$g_aLangMessages2[114] = _Localization_Load("Messages2", "Tools_Install_IP6", "Installing the TCP/IP v6 protocol.")
	$g_aLangMessages2[115] = _Localization_Load("Messages2", "Tools_Uninstall_IP6", "Uninstalling the TCP/IP v6 protocol.")
	$g_aLangMessages2[116] = _Localization_Load("Messages2", "Tools_Repair_WorkGroup", "Repairing Workgroup Computers view.")
...
Func _Localization_Preferences()
	...
	$g_aLangPreferences[4]  = _Localization_Load("Preferences", "Group_Redundancy", "Redundancy")
	$g_aLangPreferences[5]  = _Localization_Load("Preferences", "Group_Cache", "Cache")
	...
	$g_aLangPreferences[8]  = _Localization_Load("Preferences", "Checkbox_Backup_Folders", "Backup Folders Before Removing")
	$g_aLangPreferences[9]  = _Localization_Load("Preferences", "Checkbox_Export_IP", "Export IP Configuration before resetting.")
	$g_aLangPreferences[10] = _Localization_Load("Preferences", "Checkbox_Cache_Exit", " Clear cache on exit")
	$g_aLangPreferences[11] = _Localization_Load("Preferences", "Label_Cache_Size", "Cache Size: %s KB")
	$g_aLangPreferences[12] = _Localization_Load("Preferences", "Button_Cache_Clear", "Clear Cache")
	$g_aLangPreferences[13] = _Localization_Load("Preferences", "Checkbox_Enable_Logging", " Enable logging")
	$g_aLangPreferences[14] = _Localization_Load("Preferences", "Label_Log_Exceed", "Log size must not exceed :")
	$g_aLangPreferences[15] = _Localization_Load("Preferences", "Label_Logging_Size", "Logging Size: %s KB")
	$g_aLangPreferences[16] = _Localization_Load("Preferences", "Button_Logging_Clear", "Clear Logging")
	$g_aLangPreferences[17] = _Localization_Load("Preferences", "Label_Language_Message", "Select the language you prefer and press the %s button to continue. (Restart Required)")
	$g_aLangPreferences[18] = _Localization_Load("Preferences", "Button_Save", "Save")
	$g_aLangPreferences[19] = _Localization_Load("Preferences", "Button_Cancel", "Cancel")
	$g_aLangPreferences[20] = _Localization_Load("Preferences", "Label_Updated", "Preferences Updated")
	$g_aLangPreferences[21] = _Localization_Load("Preferences", "Label_Cache_Cleared", "Cache cleared")
	$g_aLangPreferences[22] = _Localization_Load("Preferences", "Label_Logging_Cleared", "Logging cleared")
	$g_aLangPreferences[23] = _Localization_Load("Preferences", "MsgBox_Language_Title", "Language Changed")
	$g_aLangPreferences[24] = _Localization_Load("Preferences", "MsgBox_Language_Message", "The selected language has changed. Complete Internet Repair should be restarted for the chosen language to take effect.")
	$g_aLangPreferences[25] = _Localization_Load("Preferences", "MsgBox_Closing_Title", "Closing %{Program.Name}")
	$g_aLangPreferences[26] = _Localization_Load("Preferences", "MsgBox_Closing_Message", "Would you like to close %{Program.Name} now?")
